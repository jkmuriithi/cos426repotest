...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:bn,depthTest:!1,depthWrite:!1})}function ua(){return new jn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Zr(),fragmentShader:`
		...
		`,blending:bn,depthTest:!1,depthWrite:!1})}function da(){return new jn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Zr(),fragmentShader:`
...
`].filter(Gi).join(`
`)),a=Gr(a),a=ya(a,t),a=Ea(a,t),o=Gr(o),o=ya(o,t),o=Ea(o,t),a=Sa(a),o=Sa(o),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(v=`#version 300 es
