...
#define LOW_PRECISION`),t}function Rp(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===ol?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===al?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===pn&&(t="SHADOWMAP_TYPE_VSM"),t}function Cp(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case Ei:case wi:t="ENVMAP_TYPE_CUBE";break;case zs:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Pp(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case wi:t="ENVMAP_MODE_REFRACTION";break}return t}function Lp(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case Bs:t="ENVMAP_BLENDING_MULTIPLY";break;case Ac:t="ENVMAP_BLENDING_MIX";break;case Rc:t="ENVMAP_BLENDING_ADD";break}return t}function Dp(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function Ip(r,t,e,n){const i=r.getContext(),s=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=Rp(e),c=Cp(e),h=Pp(e),d=Lp(e),u=Dp(e),m=e.isWebGL2?"":yp(e),g=Mp(s),_=i.createProgram();let p,f,v=e.glslVersion?"#version "+e.glslVersion+`
